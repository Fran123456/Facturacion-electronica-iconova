...
class DteReenvioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('mail.invalidacion')
                    ->with([
                    ...
                    ->attachData($pdf->output(), $this->mailinfo['dte']['identificacion']['numeroControl'] ."-INVALIDADO". '.pdf', [
