...
<p>Te informamos que lamentablemente hemos detectado un problema en tu factura por dicha razón hemos invalidado el documento.</p>
  ...
  <br><br>
  <strong>código de generación:</strong> {{ $mailinfo['codigoGeneracion'] }}  <br>
  <strong>sello de recibido:</strong> {{ $mailinfo['sello']  }}  <br>
  <strong>Número de control:</strong> {{ $mailinfo['numeroControl'] }}
