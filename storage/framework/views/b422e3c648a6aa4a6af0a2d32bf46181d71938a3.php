...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
      ...
      <h1><?php echo e($titulo_nuevo); ?></h1>

      <?php echo $html_controlador; ?>
    ...
    */
    ...
    <form action="" method ="POST">
        ...
        <label>COD. DTE:</label>
        <input type="text" name="codigo_dte" placeholder="Numero de DTE a generar PDF" value="">
...
<?php /**PATH C:\laragon\www\fe-gral\resources\views/main.blade.php ENDPATH**/ ?>