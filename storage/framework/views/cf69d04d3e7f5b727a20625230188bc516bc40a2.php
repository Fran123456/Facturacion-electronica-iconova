...
<div id="m_-2033190933289575797notification" style="height:auto;background-color:#ffffff;margin-left:auto;margin-right:auto;width:80%;max-width:550px"><span class="im">
 ...
 -->
   ...
   <p>Estimado cliente  <?php echo e(strtoupper($nombreCliente)); ?></p>
...
<p>Te adjuntamos con mucho gusto la <strong>factura electrónica</strong> correspondiente a tu compra.</p>
  ...
  <br><br>
  <strong>código de generación:</strong> <?php echo e($mailinfo['responseData']['codigoGeneracion']); ?>  <br>
  <strong>sello de recibido:</strong> <?php echo e($mailinfo['responseData']['selloRecibido']); ?>  <br>
  <strong>Número de control:</strong> <?php echo e($mailinfo['dte']['identificacion']['numeroControl']); ?>
...
<p>Si necesitas más información sobre tu factura o 
    ...
    <a href="mailto:<?php echo e($correoEmpresa); ?>" 
    target="_blank"><?php echo e($correoEmpresa); ?></a>.</p><span class="im">
...
<p>¡Gracias por confiar en nosotros para ofrecerte un servicio Súper!</p>
  ...
  <div id="m_-2033190933289575797notification-footer" style="width:100%;background-color:#c7cad6;padding:0.5em 0 0.5em 0">
   <p style="font-size:0.7em;margin:0.5em 2em 0.5em 2em;text-align:center;color:#333333">
    ...
    para comunicarte con nosotros llámanos al <?php echo e($telefonoEmpresa); ?> 
    o escríbenos a: <a href="mailto:<?php echo e($correoEmpresa); ?>" 
    style="text-decoration:none;font-weight:bold;color:#333333" 
    target="_blank"><?php echo e($correoEmpresa); ?></a></p>
  </div>
 </span></div>
...
</html><?php /**PATH C:\laragon\www\fe-gral\resources\views/mail/mail.blade.php ENDPATH**/ ?>